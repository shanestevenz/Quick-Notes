...
Link to Website (Quick notes): https://quick-notes.glitch.me/login
...
- Server-side programming _using Node.js_. Typically this will take the form of some sort of persistent data (database), authentication, and possibly server-side computation.
